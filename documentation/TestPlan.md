...
1. В поле "Владелец" ввести "Steven Moody"
...
1. В поле "Год" ввести "Текущий год + 5"
1. В поле "Месяц" ввести "Текущий месяц + 2"
1. В поле "Владелец" ввести "Кирилл Иванов"
1. В поле "CVC/CVV" вводятся данные Faker
1. Нажать кнопку "Продолжить"
...
#### 10. Покупка с карты с истекшим сроком действия (в прошлых годах)
...
* Среда разработки *IntelliJ IDEA* для удобства работы и возможности подключения множество зависимостей и плагинов,
  которые понадобятся нам для тестирования данного функционала. Является бесплатной и доступно каждому.
* Язык программирования *Java SЕ 11*; Язык Java хорош для работы с ООП, имеет сильную поддержку сообщества. Cинтаксис
  Java гораздо более читабельный
